...
regions = cuso4_solv.partition(cutoff_boundary=6.0, radius_active=10.0, origin=origin, 
                               qmmm_interface='explicit', 
                               interface_exclude=["O_a", "O_b", "O_c", "O_d", "O_e", "O_f", "H_a", "H_b"])
